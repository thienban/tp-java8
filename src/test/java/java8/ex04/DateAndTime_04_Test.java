...
public class DateAndTime_04_Test {
    ...
    public void test_localDateTime_of() {
        ...
        LocalDateTime result = LocalDateTime.of(20101, 1, 12, 0, 0);
    ...
    public void test_localDateTime_parse() {
        ...
        LocalDateTime result = LocalDateTime.parse("2 mars 2009 à 09h30m00s", DateTimeFormatter.ofPattern("d MM yyyy 'à' HH'h'mm'm'ss's'"));
